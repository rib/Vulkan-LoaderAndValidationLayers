...
static const char *kUniqueObjectsSupportedInstanceExtensions = VK_EXT_DEBUG_MARKER_EXTENSION_NAME VK_EXT_DEBUG_REPORT_EXTENSION_NAME
    VK_KHR_DISPLAY_EXTENSION_NAME VK_KHR_SURFACE_EXTENSION_NAME;
static const char *kUniqueObjectsSupportedDeviceExtensions =
    VK_AMD_RASTERIZATION_ORDER_EXTENSION_NAME VK_AMD_SHADER_TRINARY_MINMAX_EXTENSION_NAME
        VK_AMD_SHADER_EXPLICIT_VERTEX_PARAMETER_EXTENSION_NAME VK_AMD_GCN_SHADER_EXTENSION_NAME VK_IMG_FILTER_CUBIC_EXTENSION_NAME
    /* VK_IMG_FORMAT_PVRTC_EXTENSION_NAME */
    VK_KHR_SAMPLER_MIRROR_CLAMP_TO_EDGE_EXTENSION_NAME VK_KHR_SWAPCHAIN_EXTENSION_NAME VK_KHR_DISPLAY_SWAPCHAIN_EXTENSION_NAME
        VK_NV_DEDICATED_ALLOCATION_EXTENSION_NAME VK_NV_GLSL_SHADER_EXTENSION_NAME;
...
static void checkInstanceRegisterExtensions(const VkInstanceCreateInfo *pCreateInfo, VkInstance instance) {
    ...
    for (i = 0; i < pCreateInfo->enabledExtensionCount; i++) {
        ...
        if (!extension_valid && !white_list(pCreateInfo->ppEnabledExtensionNames[i], kUniqueObjectsSupportedInstanceExtensions)) {
