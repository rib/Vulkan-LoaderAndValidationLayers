...
| Invalid Queue Family Consistency | Validates that items created in one Queue Family are not submitted using a different one | INVALID_QUEUE_FAMILY | vkQueueSubmit | MismatchedQueueFamiliesOnSubmit |
