...
| MSAA Sample Count | Verifies that Draw-time, Pipeline, RenderPass, and Subpass sample counts are consistent | NUM_SAMPLES_MISMATCH | vkCmdBindPipeline vkCmdBeginRenderPass vkCmdNextSubpass vkCopyImage kCopyImageToBuffer vkCopyBufferToImage| NumSamplesMismatch ImageSampleCounts | NA |
