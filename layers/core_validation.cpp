...
static inline bool ValidImageTransferGranularity(layer_data *dev_data, const GLOBAL_CB_NODE *cb_node, const VkExtent3D *extent,
...
static inline bool CheckItgOffset(layer_data *dev_data, const GLOBAL_CB_NODE *cb_node, const VkOffset3D *offset, const uint32_t i,
    ...
    if (ValidImageTransferGranularity(dev_data, cb_node, &extent, &granularity) == false) {
        skip |= log_msg(
